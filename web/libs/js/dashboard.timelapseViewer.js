$(document).ready(function(e){
    ...
    var peerConnectKeysList = timelapseWindow.find('.peerConnectKeys_list')
    var loadedMonitors = {};
    var shinobiServer = {};
    ...
    var getLiveStream = function(){
        ...
        liveStreamView.html(`<iframe src="${shinobiServer.buildApiPrefix('timelapse') + '/' + selectedMonitor + '/jquery|fullscreen'}?host=${location.pathname}"></iframe>`)
    ...
    function drawTimelapseWindowElements(selectedMonitor,startDate,endDate){
        ...
        var frameIconsHtml = ''
        shinobiServer.getTimelapseFrames(selectedMonitor,startDate,endDate,'noLimit').then((data) => {
            if(data && data[0]){
