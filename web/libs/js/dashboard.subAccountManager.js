$(document).ready(function(){
    var theWindow = $('#tab-subAccountManager');
    ...
    function setSelectedPeerConnectKey(){
        ...
        apiPrefix = `${shinobiServer.apiBaseUrl}${shinobiServer.adminApiPrefix}accounts/${shinobiServer.groupKey}`
    ...
    var drawSubAccountRow = function(account){
        var html = `<div class="card mb-3 shadow-sm p-2" uid="${account.uid}">
            <div>
    ...
    var drawSelectableForPermissionForm = function(account){
        ...
        $.each(getLoadedMonitorsAlphabetically(shinobiServer.peerConnectKey),function(n,monitor){
    ...
    async function loadPermissions(){
        var html = ''
        const list = await shinobiServer.listPermissions()
        loadedPermissions = {}
    ...
    addOnTabReopen('subAccountManager', function () {
    ...
    drawSubMenuItems('subAccountManager',pageLayouts['Sub-Account Manager'])
})
