$(document).ready(function(e){
    ...
    function drawFileBinViewElements(selectedMonitor,startDate,endDate){
        ...
        shinobiServer.getFileBinFiles(selectedMonitor,startDate,endDate).then((data) => {
    ...
    addOnTabReopen('fileBin', function () {
