$(document).ready(function(e){
    ...
    function getHumanNamesForRowDetails(rowDetails){
        ...
        $.each(rowDetails,function(key,value){
            ...
            newDetails += `<span class="badge badge-primary mr-1">${innerText}</span>`
        })
        return newDetails
    }
    ...
    function drawApiKeyRow(row){
        var html = `<div class="card btn-default mb-3 shadow-sm p-2" api_key="${row.code}">
            <div class="row">
                <div class="col-md-6">
                    <div>
                        ${row.code}<br>
