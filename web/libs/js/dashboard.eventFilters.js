...
$(document).ready(function(e){
    ...
    var monitorsList = $('#event_filters_monitors')
    ...
    var loadedFilters = {}
    var peerConnectKeysList = detectorFiltersWindow.find('.peerConnectKeys_list')
    var loadedMonitors = {};
    var shinobiServer = {};
    ...
    monitorsList.change(function(e){
    ...
    peerConnectKeysList.change(function(){
        ...
        drawMonitorListToSelector(monitorsList,true,null,false,peerConnectKey)
    });
    addOnTabOpen('eventFilters', function () {
        ...
        drawMonitorListToSelector(monitorsList,true,null,false,firstServer)
    })
    ...
    drawSubMenuItems('eventFilters',pageLayouts['Event Filters'])
})
