module.exports = function(config,lang){
    ...
    setDefaultIfUndefined(config, 'loginScreenBackground', 'libs/img/splash.avif');
    setDefaultIfUndefined(config, 'documentationLink', 'https://docs.shinobi.video');
